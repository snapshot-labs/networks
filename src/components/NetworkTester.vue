    ...
    <div class="lg:flex lg:items-center lg:justify-between mb-4">
      ...
      <div class="mt-5 flex">
        ...
        <button type="button" @click="selectNetwork(app.selectedNetwork.key)"
          class="items-center px-4 py-2 mx-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          Refresh
